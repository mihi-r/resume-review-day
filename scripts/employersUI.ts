import { generateCheckboxes, generateSelectOption, displayWarning, validateInputFieldData, validateSelectFieldData } from './common/uiElements';
 ...
 */
const generateTimeSelectOptions = function (
